        ...
        <div className="py-5 -mt-16">
          <div className="flex justify-center">
            <Image
              ...
              loading="lazy"
              alt="Card Image"
              className="rounded-full border-2 border-primary w-20 h-20 group-hover:scale-110 duration-300"
            />
          </div>

          <p className="text-sm text-gray-400 paraFont text-center mt-7 px-2">
            {CardData.card_Description}
          </p>
          <button className="bg-primary text-white px-6 py-2 mt-7 block mx-auto rounded-lg hover:cursor-pointer hover:scale-105 duration-300">
            View All
          </button>
        </div>
      </div>
